  ...
  return (
    <div className="min-h-screen bg-neutral-50 pb-24">
      ...
      <div className="bg-gradient-to-br from-blue-700 to-blue-500 px-4 pt-10 pb-6 text-white">
        ...
        <p className="text-blue-200 text-sm mt-1">Account &amp; preferences</p>
      </div>
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <Card padding="md">
          ...
          <div className="space-y-3">
            {[
              { label: "Order notifications", value: notifyOrders, setter: setNotifyOrders },
              { label: "Price alerts", value: notifyPrices, setter: setNotifyPrices },
              { label: "Stock updates", value: notifyStock, setter: setNotifyStock },
            ].map((item) => (
