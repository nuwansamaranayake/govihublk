...
export default function SupplierMorePage() {
  ...
  useEffect(() => {
    ...
    api.get<any>("/users/me/preferences")
      .then(prefs => {
        if (prefs) {
          setNotifyOrders(prefs.match_alerts ?? true);
          setNotifyPrices(prefs.price_alerts ?? true);
          setNotifyStock(prefs.weather_alerts ?? true);
        }
      })
      .catch(() => {});
  }, [isReady]);
  ...
  return (
    <div className="min-h-screen bg-neutral-50 pb-24">
      ...
      <div className="bg-gradient-to-br from-blue-700 to-blue-500 px-4 pt-10 pb-6 text-white">
        ...
        <p className="text-blue-200 text-sm mt-1">{t("more.accountPreferences")}</p>
      </div>
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <Card padding="md">
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => router.push(`/${locale}/supplier/settings`)}
        ...
        <Card padding="md">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-semibold text-neutral-800 text-sm">{t("more.language")}</h3>
          </div>
        ...
        <Card padding="md">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-semibold text-neutral-800 text-sm">{t("more.notifications")}</h3>
          </div>
          <div className="space-y-3">
            {[
              { label: t("more.orderNotifications"), value: notifyOrders, setter: setNotifyOrders, apiKey: "match_alerts" },
              { label: t("more.priceAlerts"), value: notifyPrices, setter: setNotifyPrices, apiKey: "price_alerts" },
              { label: t("more.stockUpdates"), value: notifyStock, setter: setNotifyStock, apiKey: "weather_alerts" },
            ].map((item) => (
              <div key={item.label} className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${
                    item.value ? "bg-blue-500" : "bg-neutral-300"
                  }`}
                >
                  <div
        ...
        <Card padding="none">
          {[
            ...
            {
              label: t("more.myListings"),
              icon: (
                <svg className="w-5 h-5 text-neutral-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                </svg>
              ),
              onClick: () => router.push(`/${locale}/supplier/listings`),
            },
            {
              ...
              onClick: () => router.push(`/${locale}/supplier/notifications`),
            },
            {
        ...
        >
          ...
          {loggingOut ? t("more.loggingOut") : t("more.logOut")}
        </button>
